...
// Hidden from the actual printed ticket (@media print) — only shown when
// viewing this page in the browser, e.g. after cancelling the print dialog.
// Goes back in tab history where there is any; this page is usually opened
// as its own tab/window, so falls back to the till if there's nowhere to go.
