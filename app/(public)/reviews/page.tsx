  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <div className="text-center">
        ...
        <p className="mt-3 text-primary text-lg">{"★".repeat(Math.round(avgStars))} <span className="text-muted-foreground text-sm">({avgStars.toFixed(1)} average)</span></p>
      </div>

      <div className="mt-10 space-y-4">
        {testimonials.map((t) => (
          <div key={t.name} className="rounded-xl border border-border p-5">
      ...
      <div className="mt-12 rounded-xl border border-border bg-card p-6 text-center">
        <h2 className="font-[family-name:var(--font-playfair)] text-xl font-bold">Enjoyed your visit?</h2>
